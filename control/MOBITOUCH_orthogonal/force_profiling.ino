...
const float TOTAL_DISTANCE_M = 0.02;      // Total travel distance (12cm)
const float DENSE_INTERVAL_M = 0.01;      // Measurement point interval during dynamic phase (3cm)
const float STATIC_INTERVAL_M = 0.01;     // Measurement point interval during static phase (3cm)
